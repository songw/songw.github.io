...
[image:B27190ED-4C5F-4E1C-9E95-4ACD7FF0639E-937-0000967F333641C5/元素.png]
...
[image:CF11B3DF-C947-4178-BE98-D5D259F5A4EE-937-00008511A73695EB/WX20210521-112631@2x.png]
对应的 HTML 代码为：
```html
<!DOCTYPE html>
<html lang="en">
...
```
相应的页面如下：
[image:A40E44FC-8F97-4061-BBC2-9314369E96C9-937-000091B71B5FBB97/代码 1 页面 key.png]
...
```
相应的页面如下：
[image:C5D3E4E7-9654-418F-992D-0094B3E667C1-937-000091D9A198618A/代码 2 页面 key.png]
...
```
相应的页面如下：
[image:DBA4C6CF-15FC-467F-90D6-49C6EC4F8B30-937-0000987B80D440CD/标题 key.png]
### 4.3 图像
代码
```html
<!DOCTYPE html>
...
```
相应的页面如下：
[image:2C21AC13-A437-4804-99EF-9E152BB64C30-937-000092570EC90217/代码 3 页面 key.png]
...
```
相应的页面如下：
[image:AA0DB846-CA66-4E46-A943-EF42A019A154-937-0000A018923EBA10/代码 10 页面 key.png]
### 4.4 段落
代码
```html
<!DOCTYPE html>
...
```
相应的页面如下：
[image:1FE9A96F-2C08-4D73-A4E7-2597E2AEA766-937-0000929D96538C16/代码 4 页面 key.png]
...
```
相应的页面如下：
[image:BAE9BDAF-8354-4FAE-8E9F-7DDC8240843A-937-00009EF3EA2183BC/代码 8 页面 key.png]
HTML 代码中的空格和空行都被去掉了。
### 4.5 列表
代码
```html
...
```
相应的页面如下：
[image:D81269C8-39DE-4EAD-9D92-C58D02502DA8-937-0000940FA93C549B/代码 5 页面 key.png]
...
```
相应的页面如下：
[image:FA8D13CA-D4A6-4E3E-B96C-828DC6AAEF70-937-00009F7EC73A0CA6/代码 9 页面 key.png]
有序列表会在每个项目的前面添加一个序号。
### 4.6 链接
代码
```html
...
```
相应的页面如下：
[image:C73D754D-13EB-478A-8569-0306B4D20856-937-0000954E6E2885A5/代码 7 页面 key.png]
